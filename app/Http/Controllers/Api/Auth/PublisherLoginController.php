...
use App\Http\Requests\Auth\PublisherLoginRequest;
...
class PublisherLoginController extends Controller
{
    ...
    public function login(PublisherLoginRequest $request)
    {
        try {
    ...
    #[OA\Post(
        path: "/api/publisher/get-access-token",
    ...
    protected function createTokens(Publisher $user)
    {
