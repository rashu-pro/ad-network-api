...
class UserLoginController extends Controller
{
    ...
    protected function createTokens(User $user)
    {
        ...
        if ($isAdvertiser) {
            $campaigns = $user->campaigns()->with(['mappings.pauseHistories', 'mappings.publisherAsset', 'mappings.publisherAsset.asset'])->get();
            $totalBillTillNow = 0;
            $totalPaid = 0;
        ...
        return $this->successResponse('Logged in successfully.', [
            ...
            'earnings' => $mappings ? $mappings->map(function ($mapping) {
                ...
                return [
                    ...
                    'asset_name' => $mapping->publisherAsset->asset->name ?? null,
