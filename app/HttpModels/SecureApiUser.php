...
//            'line2' => 'required|string',
        ...
        return [
            ...
            "isAdPublisher" => $data["isAdPublisher"] ?? $data['businessCategory'] == CompanyCategory::PUBLISHER,
            "isAdvertiser" => $data["isAdvertiser"] ?? $data['businessCategory'] == CompanyCategory::ADVERTISER,
